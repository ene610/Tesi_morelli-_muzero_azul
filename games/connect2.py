...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (3, 1, 4)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
...
class Connect2:
    def __init__(self):
        self.board = numpy.zeros((1, 4), dtype="int32")
        self.player = 1
    ...
    def step(self, action):   
        if self.board[0][action] == 0:
            self.board[0][action] = self.player
    ...
    def get_observation(self):
        ...
        board_to_play = numpy.full((1, 4), self.player, dtype="int32")
    ...
    def have_winner(self):
        ...
        for i in range(3):
             ...
             if (self.board[0][i] == self.player and self.board[0][i+1] == self.player):
                  return True
